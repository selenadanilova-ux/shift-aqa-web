...
Перед запуском убедитесь, что вы находитесь в папке задания (`cd task-1-screenshot-tests`) и установили зависимости (`npm install`).
...
* **Запуск всех тестов:**
  ...
  npx playwright test
  ```
* **Запуск тестов в режиме интерфейса (UI mode):**
  ```bash
